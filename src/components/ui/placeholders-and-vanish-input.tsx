...
export function PlaceholdersAndVanishInput({
  ...
  const draw = () => {
    ...
    const computedStyles = getComputedStyle(inputRef2.current);
  ...
  return (
    <form
      className={cn(
        "w-full relative max-w-xl mx-auto bg-card h-12 rounded-full overflow-hidden shadow-lg transition duration-200 border-2 border-primary/30 hover:border-primary/60 focus-within:border-primary focus-within:shadow-[0_0_20px_hsl(var(--primary)/0.3)]",
        className
      )}
...
function AnimatedPlaceholder({
  ...
  return (
    <div className="absolute left-4 sm:left-10 text-sm sm:text-base font-normal text-neutral-500 dark:text-zinc-500 max-w-[calc(100%-2rem)] truncate">
      {!value && (
        <motion.span
