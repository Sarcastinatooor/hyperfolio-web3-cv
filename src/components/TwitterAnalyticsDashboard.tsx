...
import CampaignLeaderboard, { type CampaignEntry } from './CampaignLeaderboard';
...
const TwitterAnalyticsDashboard: React.FC<TwitterAnalyticsDashboardProps> = ({ startDate = "2024-01" }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Top Performing Campaigns — new editorial grid leaderboard */}
      <CampaignLeaderboard campaigns={topCampaigns as unknown as CampaignEntry[]} peakImpact="$100M+" />
    </div>
  );
};
